...
import com.conelius.earthquake.ui.CustomInfoWindow;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener, GoogleMap.OnMarkerClickListener {
    ...
    private BitmapDescriptor[] iconsColor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iconsColor = new BitmapDescriptor[]{
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < Constants.LIMIT; i++) {
                                ...
                                markerOptions.icon(iconsColor[Constants.randomInt(iconsColor.length,0)]);
                                markerOptions.title(earthQuake.getPlace());
                                markerOptions.position(new LatLng(lat,lon));
                                markerOptions.snippet("Magnitude: "+ earthQuake.getMagnitude() +"\n" + "Date: "+ formattedDate );

                                // Add circles to mag > x
